...
<style>
  body
{ 
  background: url(http://now-here-this.timeout.com/wp-content/uploads/2013/12/DuckWaffle.jpg) no-repeat center fixed; 
...
<body>
  <table style="height: 150;width: 100%">
    <tr>
      <th width=95%><h1 style="text-align: center;">Food Adda</h1></th>
    </tr>
  </table>  
  ...
  <form method="POST" class="modal-content form-signin animate" role="form" action="review1.php">                            
    <div class="container">
