...
<style>
  body
{ 
  background: url(http://icace2015.nitk.ac.in/sites/default/files/NITK_Surthkal_logo.png) no-repeat center fixed; 
...
<body>
  ...
  <form method="POST" class="modal-content form-signin animate" role="form" action="student1.php">                            
    <div class="container">
      <label><b>Roll Number</b></label>
      <input type="text" placeholder="Enter Roll Number" name="roll" class="form-control" required>
