...
session_start(); 
$ROLL = $_POST['block'];
$result = mysqli_query($con,"SELECT * from wardeninfo WHERE Block_num='$ROLL'");
...
<table style="height: 150;width: 100%">
    ...
    <tr>
      <th width=95%><h2 style="text-align: center;">Warden Information Portal</h2></th>
    </tr>
  </table>  
...
<table width="450" height="100" border="1px solid black" style="margin-right: 0;margin-left: 0;border-collapse: collapse;">
    ...
    <tr>
      ...
      <td width="130"><strong>Office</strong></td>
  ...
  ?><tr>
      ...
      <td>&nbsp;<?php echo $rowc["Office"];?></td>
      <td>&nbsp;<?php echo $rowc["Timings"];?></td>
      <td>&nbsp;<?php echo $rowc["Contact_num"];?></td>
      </tr>
      </table>
      <?php
    }
